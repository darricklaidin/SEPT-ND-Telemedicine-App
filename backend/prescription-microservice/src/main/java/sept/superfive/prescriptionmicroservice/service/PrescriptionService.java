package sept.superfive.prescriptionmicroservice.service;

import sept.superfive.prescriptionmicroservice.exception.ResourceAlreadyExistsException;
import sept.superfive.prescriptionmicroservice.exception.ResourceNotFoundException;
...
public class PrescriptionService {
    ...
    public Prescription getPrescriptionByID(int prescriptionID) throws ResourceNotFoundException {
        return prescriptionRepository.findByPrescriptionID(prescriptionID)
                .orElseThrow(() -> new ResourceNotFoundException(RESOURCE_NAME, "prescriptionID", prescriptionID));
    }
