package sept.superfive.authmicroservice.unit_test.services;
...
class SpecialtyServiceUnitTest {
    ...
    void getSpecialtyByID() {
        ...
        Assertions.assertEquals(specialtyService.getSpecialtyByID(specialty1.getSpecialtyID()), specialty1);
    }
    ...
    void getSpecialtyByName() {
        ...
        // Test specialty1 matches
        Assertions.assertEquals(specialtyService.getSpecialtyByName(specialty1.getSpecialtyName()), specialty1);
    }
    ...
    void createSpecialty() {
        ...
        Assertions.assertEquals(createdSpecialty, specialtyService.getSpecialtyByID(createdSpecialty.getSpecialtyID()));
